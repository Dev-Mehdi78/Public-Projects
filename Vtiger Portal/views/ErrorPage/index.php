...
<head>
    ...
    <!-- COLOR SKIN CSS -->
    <link id="theme" rel="stylesheet" type="text/css" media="all" href="resources/colors/color1.css" />    <!-- INTERNAL Switcher css -->
            ...
            <div class="container text-center">
                <div class="error-template">
                    ...
                    <div class="text-center">
                        <a class="btn btn-secondary mt-5 mb-5" href="index.php?page=Dashboard"> <i class="fa fa-long-arrow-left"></i> بازگشت به صفحه اصلی </a>
                    </div>
                </div>
            </div>
        </div>
