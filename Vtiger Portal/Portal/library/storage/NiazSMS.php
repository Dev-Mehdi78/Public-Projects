...
class SMSNotifier_NiazSMS_Provider implements SMSNotifier_ISMSProvider_Model
{
    private $username;
    private $password;
    ...
    const SERVICE_URI = 'https://login.niazpardaz.ir/SMSInOutBox/SendSms';
    ...
    public function send($message, $toNumbers)
    {
        ...
        $URL = self::SERVICE_URI.'?username='.$params['username'].'&password='.$params['password'].'&from='.$params['from'].'&to='.$params['to'].'&text='.$params['text'];
        ...
        curl_setopt_array($curl, array(
          ...
          CURLOPT_HTTPHEADER => array(
            'Cookie: ASP.NET_SessionId=ivnbe54soknq3n1wqvbyoz10'
          ),
        ));
